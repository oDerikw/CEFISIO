          ...
          <Container maxWidth="md">
            ...
            <Box textAlign="center" mb={3}>
              <Container maxWidth="xs">
                ...
                >
                  {t(
                    'Estamos trabalhando na implementação antes do lançamento!'
                  )}
                </Typography>
              </Container>
              <img
            ...
            <Box display="flex" justifyContent="center">
              {timerComponents.length ? timerComponents : <>Tempo esgotado!</>}
            </Box>
              ...
              <Box sx={{ textAlign: 'center', p: 4 }}>
                <FormControl variant="outlined" fullWidth>
                  <OutlinedInputWrapper
                    type="text"
                    placeholder={t('Insira aqui o seu endereço de email...')}
                    endAdornment={
                  ...
                  />
                  <FormHelperText>
                    {t('Enviaremos um email após o lançamento!')}
                  </FormHelperText>
                </FormControl>
                <Divider sx={{ my: 4 }} />
